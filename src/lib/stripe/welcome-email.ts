...
/**
 * Sends the post-purchase welcome email to a UGotLeads buyer.
 *
...
export async function sendFoundersWelcomeEmail({
  ...
  const subject = `Welcome to UGotLeads — your access is on the way`;

  const affiliatePsText = affiliateCode
    ? `

P.S. You're now an affiliate. Earn commission on every UGotLeads purchase
you refer.

Your code:      ${affiliateCode}
Your link:      https://ugotleads.io/?ref=${affiliateCode}
Dashboard:      https://ugotleads.io/affiliate/login
`
    : "";

  const text = `Welcome to UGotLeads.

Within 24 hours we'll email you your private GitHub repo access and
onboarding details. Watch for a message from notifications@ugotleads.io
(check spam if you don't see it).

Have a question before then? Open the chat widget at ugotleads.io — we
usually reply within a few hours.

Join the Founders community
---------------------------

Other UGotLeads founders trade wins, code patterns, and client stories
inside our private Skool community. Free for all founders — join here:

https://www.skool.com/ambitious

Thanks for backing UGotLeads.
...
<head>
<meta charset="utf-8" />
<title>Welcome to UGotLeads</title>
</head>
    ...
    <tr>
      <td align="center">
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="560" style="max-width:560px;background:#ffffff;border-radius:14px;border:1px solid #e8e8ec;overflow:hidden;">
          <tr>
            <td style="padding:32px 32px 8px 32px;">
              <h1 style="margin:0;font-size:22px;line-height:1.3;font-weight:600;letter-spacing:-0.01em;">Welcome to UGotLeads.</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:16px 32px 8px 32px;">
              <p style="margin:0 0 16px 0;font-size:15px;line-height:1.6;color:#1a1a22;">
                Within 24 hours we'll email you your private GitHub repo access and onboarding details. Watch for a message from <strong>notifications@ugotleads.io</strong> &mdash; check spam if you don't see it.
              </p>
              <p style="margin:0;font-size:15px;line-height:1.6;color:#1a1a22;">
                Have a question before then? Open the chat widget at <a href="https://ugotleads.io" style="color:#5b5bd6;text-decoration:none;">ugotleads.io</a> &mdash; we usually reply within a few hours.
              </p>
            </td>
          </tr>
          <tr>
              ...
              <a href="https://www.skool.com/ambitious" style="display:block;text-decoration:none;color:inherit;">
                <div style="background:linear-gradient(135deg,#eef0ff 0%,#fdeaf6 100%);border:1px solid #e2dcfc;border-radius:10px;padding:18px 20px;">
                  ...
                  <p style="margin:0 0 8px 0;font-size:14px;line-height:1.55;color:#1a1a22;">
                    Trade wins, code patterns, and client stories with other UGotLeads founders inside our private Skool. Free for all founders.
                  </p>
          ...
          <tr>
            <td style="padding:16px 32px 32px 32px;">
              <p style="margin:16px 0 0 0;font-size:14px;line-height:1.55;color:#6b6b75;">
                Thanks for backing UGotLeads.<br />
                &mdash; The UGotLeads team
              </p>
            </td>
          </tr>
          ${
            ...
            <td style="padding:0 32px 32px 32px;">
              <div style="background:linear-gradient(135deg,#eef0ff 0%,#fdeaf6 100%);border:1px solid #e2dcfc;border-radius:10px;padding:18px 20px;">
                ...
                <p style="margin:0 0 12px 0;font-size:14px;line-height:1.55;color:#1a1a22;">
                  Earn commission on every UGotLeads purchase you refer.
                </p>
                <p style="margin:0;font-size:13px;line-height:1.6;color:#3a3a44;">
                  ...
                  Your link: <a href="https://ugotleads.io/?ref=${affiliateCode}" style="color:#5b5bd6;text-decoration:none;word-break:break-all;">https://ugotleads.io/?ref=${affiliateCode}</a><br />
                  Dashboard: <a href="https://ugotleads.io/affiliate/login" style="color:#5b5bd6;text-decoration:none;">ugotleads.io/affiliate/login</a> (sign in with this email)
                </p>
              </div>
            </td>
          </tr>`
        ...
        <p style="margin:16px 0 0 0;font-size:11px;color:#9a9aa3;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
          You're receiving this because you purchased UGotLeads at ugotleads.io.
        </p>
      </td>
    </tr>
  </table>
