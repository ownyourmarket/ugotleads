    ...
    <div className="space-y-6">
      ...
      <section>
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          <WorkflowCard
            title="AI Agents (Web Chat + SMS)"
            description="Configure one persona that powers every channel. The Web Chat widget embeds on the client's site; SMS auto-replies route through the sub-account's Twilio number. When the bot captures a name/email/phone via the inline form, a Contact is created, a follow-up Task is added to today's queue, and the escalation email fires."
            highlight
          >
            <WorkflowDiagram
              steps={[
